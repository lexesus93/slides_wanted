...
export type AnimationType = 'fade' | 'slide' | 'bounce' | 'zoom' | 'rotate' | 'flip' | 'none';
...
export type TemplateCategory = 'business' | 'education' | 'creative' | 'marketing' | 'startup' | 'corporate';
...
export type LayoutType = 'title' | 'content' | 'two-column' | 'comparison' | 'process' | 'conclusion' | 'custom';
...
export type ContentType = 'business_pitch' | 'educational' | 'marketing' | 'report' | 'portfolio' | 'other';
...
export declare const SUBSCRIPTION_TIERS: readonly ["free", "premium", "enterprise"];
export declare const PRESENTATION_STATUSES: readonly ["draft", "ready", "exported"];
export declare const EXPORT_FORMATS: readonly ["pptx", "pdf", "html", "png", "jpg"];
export declare const EXPORT_STATUSES: readonly ["pending", "processing", "completed", "failed", "cancelled"];
export declare const TEMPLATE_CATEGORIES: readonly ["business", "education", "creative", "marketing", "startup", "corporate"];
export declare const LAYOUT_TYPES: readonly ["title", "content", "two-column", "comparison", "process", "conclusion", "custom"];
export declare const CONTENT_TYPES: readonly ["business_pitch", "educational", "marketing", "report", "portfolio", "other"];
